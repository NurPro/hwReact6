	...
	return (
		<Card>
			<CardContainer>
				<ContainerOne>
					<DateContainer>
						<FirstSpanMonth>{dateMonth}</FirstSpanMonth>
						<SecondSpanDate>{+date}</SecondSpanDate>
						<ThirdSpanYear>{+fullYear}</ThirdSpanYear>
					</DateContainer>
...
const FirstSpanMonth = styled.span`
...
const SecondSpanDate = styled.span`
	font-family: 'Montserrat';
	font-style: normal;
	font-weight: 600;
	font-size: 22px;
...
const ThirdSpanYear = styled.span`
	font-family: 'Montserrat';
	font-style: normal;
	font-weight: 800;
	font-size: 16px;
